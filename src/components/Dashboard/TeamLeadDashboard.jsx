...
import UserList from './UserList'; // <-- New Import

const TeamLeadDashboard = ({ changeUser, updateSnippet, deleteSnippet }) => {
  ...
  const allSnippets = userData
    ? userData.flatMap(dev =>
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {activeTab === 'users' && <UserList developers={userData} />}
